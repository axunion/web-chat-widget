...
Applies when touching anything under `tests/` or the Vitest config. The project is TDD-driven (see CLAUDE.md and ARCHITECTURE.md §Testing Strategy) — tests are first-class.
